...
for budget in budgets:
    ...
    train_df = pd.read_csv(f"../data/ela_for_training/A1_data_switch_normalized_log/A1_B{budget}_5D_ela_with_state.csv")
    ...
    # clf = joblib.load(f"rf_models/rf_model_B{budget}_late.pkl")
    clf.fit(X_train, y_train)

    # Save the model    
    model_path = f"../data/models/trained_models/switching_normalized_log/selector_B{budget}_trained.pkl"
