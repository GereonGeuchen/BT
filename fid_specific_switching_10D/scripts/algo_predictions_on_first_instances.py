...
def crossvalidated_static_predictions(
    budget,
    fold="instance",
    selector_dir="../data/models/algo_performance_models_normalized_log10_200_10D",
    ela_template="../data/ela_for_training/A1_data_ela_with_precisions_10D_normalized/A1_B{budget}_10D_ela_with_state.csv",
    precision_df=None
):
...
def build_full_crossvalidated_table(precision_path, output_dir = None):
    ...
    for budget in budgets:
        ...
        if budget < 2000:
            ...
            df_b = precision_df.query("budget == 2000 and algorithm == 'Same'")
            df_b = df_b[["fid", "iid", "rep", "precision"]].rename(columns={"precision": "static_B2000"})
...
if __name__ == "__main__":
    build_full_crossvalidated_table(
        "../data/precision_files/A2_precisions_10D.csv",
