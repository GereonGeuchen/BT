...
SWITCHING_BUDGETS = [20*i for i in range(1, 10)] + [100*i for i in range(2, 20)]
...
# === Paths ===
ELA_DIR_SWITCH = "../data/ela_for_training/A1_data_switch_normalized_log10_200_10D"
ELA_DIR_ALGO = "../data/ela_for_training/A1_data_ela_with_precisions_10D_normalized"
PRECISION_FILE = "../data/precision_files/A2_precisions_10D_log10.csv"
CV_MODELS_DIR = "../data/models/trained_models/algo_performance_models_cv"
UNTRAINED_PERF_MODELS_DIR = "../data/models/algo_performance_models_normalized_log10_200_10D"
SMAC_OUTPUT_DIR = "smac_output_switching_10D"
OUTPUT_PATH = "../data/models/tuned_models/switching_models_10D"
# ========== Helper classes ==========
...
class SwitchingSelectorCV:
    ...
    def simulate_single_run(self, fid, iid, rep, switching_models, performance_models):
        ...
        for budget in SWITCHING_BUDGETS:
            ...
            ela_path = Path(ELA_DIR_ALGO) / f"A1_B{budget}_10D_ela_with_state.csv"
...
def train_models_for_iid(test_iid, config, selector):
    ...
    for budget in SWITCHING_BUDGETS:
        print(f"Training models for IID {test_iid}, budget {budget}")
        ela_path_switch = Path(ELA_DIR_SWITCH) / f"A1_B{budget}_10D_ela_with_state.csv"
        ...
        ela_path_algo = Path(ELA_DIR_ALGO) / f"A1_B{budget}_10D_ela_with_state.csv"
