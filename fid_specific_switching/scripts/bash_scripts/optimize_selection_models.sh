...
#!/bin/bash
#SBATCH -A thes2015
#SBATCH --job-name=switch_model_optimization_clipped_normalized
#SBATCH --output=${WORKDIR}/logs/switch_model_optimization_clipped_normalized.out
#SBATCH --error=${WORKDIR}/logs/switch_model_optimization_clipped_normalized.err
