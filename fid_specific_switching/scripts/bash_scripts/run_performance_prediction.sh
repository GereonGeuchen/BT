...
#!/bin/bash
#SBATCH -A thes2015
#SBATCH --job-name=performance_prediction_clipped
#SBATCH --output=${WORKDIR}/logs/performance_prediction_clipped.out
#SBATCH --error=${WORKDIR}/logs/performance_prediction_clipped.err
