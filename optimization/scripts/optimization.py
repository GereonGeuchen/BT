...
def train_and_save_selector_only(mode: str, budget: int):
    ...
    if mode == "performance":
        ...
        data_path = f"../data/A1_data_ela_cma_std_precisions_normalized_clipped/A1_B{budget}_5D_ela_with_state.csv"
        ...
        if budget < 100 and budget != 50:
            data_path = f"../data/ela_with_optimal_precisions/A1_data_ela_with_optimal_precisions_early/A1_B{budget}_5D_ela_with_state.csv"
            y_cols = -(19 + ( (96 - budget) // 8 ) + 1) 
        else:
            data_path = f"../data/ela_with_optimal_precisions/A1_data_ela_with_optimal_precisions_late/A1_B{budget}_5D_ela_with_state.csv"
...
def main():
    parser = argparse.ArgumentParser(description="Run train_and_save_selector_only with given budget")
    parser.add_argument("budget", type=int, help="Budget value to use")
