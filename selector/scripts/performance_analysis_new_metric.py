...
def display_vbs_tables(csv_path, fid=None, plot_type="table"):
    ...
    if fid is None:
        ...
        output_path = "../results/newInstances/precision_ratios.pdf"
...
if __name__ == "__main__":
    ...
    result_csv_path = "../results/newInstances/selector_results_newInstances_200_200.csv"
    # df = pd.read_csv(result_csv_path)
    # df = pd.read_csv(result_csv_path)
    ...
    display_vbs_tables(result_csv_path, fid=None)