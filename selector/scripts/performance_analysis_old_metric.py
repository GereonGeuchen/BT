...
sbs_sum = 3656.765863 # For new reps
...
if __name__ == "__main__":
    precision_path = "../data/A2_newReps_precisions.csv"  # Replace with your actual file path
    result_path = "../results/result_csvs/selector_results_with_vbs_selector.csv"
    res = find_sbs(precision_path)
    for i, row in res.iterrows():
        print(f"{row['budget']:>3} | {row['algorithm']:<20} | {row['precision']:.6f}")
    ...
    # res = compute_vbs_ratios("../results/result_csvs/selector_results_newReps.csv")
