...
def calculate_ela_features(budget):
    base_folder = "../data/run_data_csvs/A1_data_newInstances"   # FIXED
    output_folder = "../data/ela_data_new/A1_data_ela_newInstances"              # FIXED
...
if __name__ == "__main__":
    ...
    with warnings.catch_warnings():
        ...
        append_standard_deviation_stats(budget=budget,
                                        ...
                                        raw_data_path=f"../data/run_data_csvs/A1_data_newInstances/A1_B{budget}_5D.csv",
