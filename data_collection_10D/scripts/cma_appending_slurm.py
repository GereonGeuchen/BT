...
def append_cma_state_to_ela(ela_dir, run_dir, output_dir, budgets):
    ...
    for budget in budgets:
        ...
        ela_path = os.path.join(ela_dir, f"A1_B{budget}_10D_ela.csv")
        run_path = os.path.join(run_dir, f"A1_B{budget}_10D")
        ...
        for _, row in df_ela.iterrows():
            ...
            pattern = os.path.join(run_path, f"data_f{fid}*", f"IOHprofiler_f{fid}_DIM10.dat")
        ...
        out_path = os.path.join(output_dir, f"A1_B{budget}_10D_ela_with_state.csv")
...
if __name__ == "__main__":
    ...
    append_cma_state_to_ela(
        ela_dir="../data/ela_data_new/A1_data_ela_10D_newInstances",
        run_dir="../data/run_data_10D/A1_data_newInstances_10D_new_sp",
        output_dir="../data/ela_with_cma/A1_data_with_cma_10D_newInstances",
        budgets=[budget]
    )