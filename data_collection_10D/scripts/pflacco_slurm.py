...
def calculate_ela_features(budget):
    base_folder = "../data/run_data_csvs/A1_data_10D_newInstances"   # FIXED
    output_folder = "../data/ela_data_new/A1_data_ela_10D_newInstances"              # FIXED

    os.makedirs(output_folder, exist_ok=True)
    filename = f"A1_B{budget}_10D.csv"
    ...
    output_path = os.path.join(output_folder, f"A1_B{budget}_10D_ela.csv")
...
def append_standard_deviation_stats(budget, ela_path, raw_data_path, output_path):
    ...
    tail_counts = {20: [1,2], 40: [1,2,4], float("inf"): [1, 2, 5]}
...
if __name__ == "__main__":
    ...
    with warnings.catch_warnings():
        ...
        append_standard_deviation_stats(budget=budget,
                                        ela_path=f"../data/ela_with_cma/A1_data_with_cma_10D_newInstances/A1_B{budget}_10D_ela_with_state.csv",
                                        raw_data_path=f"../data/run_data_csvs/A1_data_10D_newInstances/A1_B{budget}_10D.csv",
                                        output_path=f"../data/ela_with_cma_std/A1_data_ela_cma_std_10D_newInstances/A1_B{budget}_10D_ela_with_state.csv")
